...
class AnimatedSplashScreen extends StatefulWidget {
  ...
  factory AnimatedSplashScreen(
      {Curve curve = Curves.easeInCirc,
        ...
        Widget backgroundView = const SizedBox(),
    ...
    return AnimatedSplashScreen._internal(
      ...
      splash: splash,
      type: type ?? SplashType.simpleSplash,
...
class _AnimatedSplashScreenState extends State<AnimatedSplashScreen>
  ...
  void initState() {
    ...
    _animationController.forward().then((value) => doTransition()).whenComplete((){
  ...
  Widget getBackgroundView(){
    return w.backgroundView??const SizedBox();
  }


  Widget getBody(){
    return w.backgroundView==null?getSplash():Stack(children: [getBackgroundView(),getSplash()],);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: w.backgroundColor, body: getBody());
  }
}